...
public class AppointmentRequestFrame extends javax.swing.JFrame {
    ...
    public AppointmentRequestFrame() {
        ...
        model=(DefaultTableModel)jtAllAppoin.getModel();
    ...
    private void initComponents() {
        ...
        jtAllAppoin = new javax.swing.JTable();
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, -1, 50));

        jSeparator2.setBackground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 80, 530, 12));

        jSeparator1.setBackground(new java.awt.Color(250, 248, 196));
        jSeparator1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 20, 580, 70));
        ...
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -230, 1010, 560));
        ...
        jtAllAppoin.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Patient ID", "Patient Name", "OPD", "Appointment Date", "Mobile no."
            }
        ) {
        ...
        jtAllAppoin.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtAllAppoinMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jtAllAppoin);
        ...
        jLabel17.setText("View Appointments");
        jPanel3.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 240, -1));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1010, 720));
    ...
    private void jtAllAppoinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtAllAppoinMouseClicked
        int rowIndex=jtAllAppoin.getSelectedRow();
        AppointmentPojo app=appList.get(rowIndex);
        ConformAppointmentFrame cfrm=new ConformAppointmentFrame(app);
        this.dispose();
        cfrm.setVisible(true);
    }//GEN-LAST:event_jtAllAppoinMouseClicked
    ...
    private javax.swing.JTable jtAllAppoin;
